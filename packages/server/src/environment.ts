...
const DEFAULTS = {
  ...
  AUTOMATION_LOOPS_RESULTS_THRESHOLD: 50,
}
...
const environment = {
  ...
  AUTOMATION_LOOPS_RESULTS_THRESHOLD:
    parseIntSafe(process.env.AUTOMATION_LOOPS_RESULTS_THRESHOLD) ||
    DEFAULTS.AUTOMATION_LOOPS_RESULTS_THRESHOLD,
