...
import m20260301144039_remove_unused_ai_configs from "./migrations/20260301144039_remove_unused_ai_configs"
...
export const MIGRATIONS: WorkspaceMigration[] = [
  ...
  {
    id: "20260301144039_remove_unused_ai_configs",
    func: m20260301144039_remove_unused_ai_configs,
  },
]
