...
import m20260518120000_recreate_search_index from "./migrations/20260518120000_recreate_search_index"
...
export const MIGRATIONS: WorkspaceMigration[] = [
  ...
  {
    id: "20260518120000_recreate_search_index",
    func: m20260518120000_recreate_search_index,
  },
]
