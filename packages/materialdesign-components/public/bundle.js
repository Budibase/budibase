...
var app = (function (bcrypt) {
    ...
    var name = "@budibase/materialdesign-components";
    var svelte = "src/index.svelte";
    ...
    var license = "MIT";
    var gitHead = "115189f72a850bfb52b65ec61d932531bf327072";
    var packageJson = {
    	name: name,
    	svelte: svelte,
    	main: main,
    ...
    const file$1 = "src\\Test\\TestApp.svelte";
    ...
    function create_then_block(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(div, file$1, 27, 0, 412);
    		},
    ...
    class TestApp extends SvelteComponentDev {
    	constructor(options) {
    		...
    		dispatch_dev("SvelteRegisterComponent", { component: this, tagName: "TestApp", options, id: create_fragment.name });
    	}
    }
