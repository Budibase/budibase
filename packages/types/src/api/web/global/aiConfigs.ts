...
export interface AIConfigResponse extends Pick<
...
export type CreateAIConfigRequest = WithoutDocMetadata<
  Omit<AIConfigResponse, "configType">
> & {
  configType?: AIConfigResponse["configType"]
}
