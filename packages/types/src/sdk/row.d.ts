...
export interface NumericAggregation extends BaseAggregation {
    calculationType: CalculationType.AVG | CalculationType.MAX | CalculationType.MIN | CalculationType.SUM;
    field: string;
}
...
export type Aggregation = NumericAggregation | CountAggregation | CountDistinctAggregation;
...
export declare enum RowExportFormat {
    CSV = "csv",
    JSON = "json",
