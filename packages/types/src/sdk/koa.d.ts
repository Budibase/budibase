...
import { User, Role, UserRoles, Account, ConfigType, Row, Table, UserBindings } from "../documents";
...
export interface ContextEmitter {
    ...
    emitTable(eventName: EventType.TABLE_SAVE | EventType.TABLE_DELETE, appId: string, table?: Table): void;
}
