...
exports.GroupByTypes = exports.NumericTypes = exports.JsonTypes = exports.FieldType = void 0;
...
(function (FieldType) {
     ...
     */
    FieldType["ATTACHMENTS"] = "attachment";
    /**
     ...
     */
    FieldType["ATTACHMENT_SINGLE"] = "attachment_single";
    /**
...
exports.NumericTypes = [FieldType.NUMBER, FieldType.BIGINT];
function isNumeric(type) {
    return exports.NumericTypes.includes(type);
}
...
function canGroupBy(type) {
    return exports.GroupByTypes.includes(type);
}
