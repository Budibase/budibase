...
export const SpectrumIconMap: Record<string, string> = {
  ...
  DistributeBottomEdge: "align-vertical",
  DistributeHorizontalCenter: "align-horizontal",
  DistributeLeftEdge: "align-horizontal",
  DistributeRightEdge: "align-horizontal",
  DistributeSpaceHoriz: "align-horizontal",
  DistributeSpaceVert: "align-vertical",
  DistributeTopEdge: "align-vertical",
  DistributeVerticalCenter: "align-vertical",
