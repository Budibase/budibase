...
export const SpectrumIconMap: Record<string, string> = {
  ...
  DistributeBottomEdge: "distribute-vertical",
  DistributeHorizontalCenter: "distribute-horizontal",
  DistributeLeftEdge: "distribute-horizontal",
  DistributeRightEdge: "distribute-horizontal",
  DistributeSpaceHoriz: "distribute-horizontal",
  DistributeSpaceVert: "distribute-vertical",
  DistributeTopEdge: "distribute-vertical",
  DistributeVerticalCenter: "distribute-vertical",
  DistributeVertically: "distribute-vertical",
  Document: "file-text",
