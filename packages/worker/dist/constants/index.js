...
const TemplateMetadata = {
    [TemplateTypes.EMAIL]: [
        ...
        },
        {
            ...
            description: "When a user requests a password reset they will receive an email built with this template.",
            ...
            bindings: [
                ...
                },
                {
                    ...
                    description: "The temporary password reset code used in the recipients password reset URL.",
                },
            ],
        },
        {
            name: "User welcome",
            description: "When a new user is added they will be sent a welcome email using this template.",
            category: "user management",
            ...
            bindings: [
                {
                    ...
                    description: "The URL the recipient must click to accept the invitation and activate their account.",
                },
                {
        ...
        {
            name: "Custom",
            description: "A custom template, this is currently used for SMTP email actions in automations.",
...
exports.TemplatePurpose = Object.assign({}, EmailTemplatePurpose);
