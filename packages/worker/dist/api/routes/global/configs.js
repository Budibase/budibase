...
router
    .post("/api/global/configs", adminOnly, buildConfigSaveValidation(), controller.save)
    ...
    .get("/api/global/configs/all/:type", buildConfigGetValidation(), controller.fetch)
    ...
    .post("/api/global/configs/upload/:type/:name", adminOnly, buildUploadValidation(), controller.upload);
