...
{#snippet toolCard(
  ...
  {@const retrievalDiagnostics =
    item.name === "search_knowledge"
      ? parseKnowledgeRetrievalDiagnostics(content)
      : undefined}
    ...
    {#if retrievalDiagnostics}
      <div class="retrieval-summary">
        <div class="retrieval-row">
          ...
          <span class="retrieval-value">{retrievalDiagnostics.query}</span>
        </div>
        <div class="retrieval-grid">
          <div class="retrieval-row">
            <span class="retrieval-label">Knowledge bases</span>
            <span class="retrieval-value">
              {retrievalDiagnostics.knowledgeBaseCount}
            </span>
          </div>
          <div class="retrieval-row">
            <span class="retrieval-label">Files</span>
            <span class="retrieval-value">
              {retrievalDiagnostics.readyFileCount} ready / {retrievalDiagnostics.totalFileCount}
              total
            </span>
          </div>
          <div class="retrieval-row">
            ...
            <span class="retrieval-value">
              {retrievalDiagnostics.skippedFileCount}
            </span>
          </div>
          <div class="retrieval-row">
            <span class="retrieval-label">Chunks</span>
            <span class="retrieval-value">
              {retrievalDiagnostics.acceptedChunkCount} accepted / {retrievalDiagnostics.returnedChunkCount}
              returned
            </span>
          </div>
          <div class="retrieval-row">
            ...
            <span class="retrieval-value">
              {formatDuration(retrievalDiagnostics.durationMs)}
            </span>
          </div>
          {#if retrievalDiagnostics.noResultReason}
            <div class="retrieval-row">
              <span class="retrieval-label">No result reason</span>
              <span class="retrieval-value">
                {formatNoResultReason(retrievalDiagnostics.noResultReason)}
              </span>
            </div>
          {/if}
        </div>
        <div class="retrieval-row">
          ...
          <span class="retrieval-value">
            {#if retrievalDiagnostics.sources.length}
              {retrievalDiagnostics.sources
