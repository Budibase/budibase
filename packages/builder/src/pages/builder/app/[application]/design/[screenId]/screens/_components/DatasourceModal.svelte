<script>
  ...
  onMount(async () => {
    try {
      ...
      notifications.error(
        $_(
          "pages.builder.app.application.design.screenId.screens._components.DatasourceModal.Error_fetching"
        )
      )
    }
  })
...
<span>
  <ModalContent
    title={$_(
      "pages.builder.app.application.design.screenId.screens._components.DatasourceModal.Autogenerated_screens"
    )}
    confirmText={$_(
      "pages.builder.app.application.design.screenId.screens._components.DatasourceModal.Confirm"
    )}
    cancelText={$_(
      "pages.builder.app.application.design.screenId.screens._components.DatasourceModal.Back"
    )}
  ...
  >
    <Body size="S">
      {$_(
        "pages.builder.app.application.design.screenId.screens._components.DatasourceModal.Select_datasources"
      )}
    </Body>
