...
import { auth, environment, licensing } from "stores/portal"
import { onMount } from "svelte"
import { AUTH_TYPES, AUTH_TYPE_LABELS } from "./authTypes"
...
const checkErrors = () => {
  ...
  const basicAuthErrors = () => {
    errors.basic.username = form.basic.username ? null : "Username is required"
    errors.basic.password = form.basic.password ? null : "Password is required"
