        ...
        >
          {#each conditions as condition (condition.id)}
            <div class="condition" animate:flip={{ duration: flipDurationMs }}>
              ...
              <Select options={settingOptions} bind:value={condition.setting} />
              <div>TO</div>
              <ColorPicker
              ...
              />
              <div>IF</div>
              <Select options={columns} bind:value={condition.column} />
              <Select
                placeholder={null}
...
<style>
  ...
  .condition {
    ...
    display: grid;
    align-items: center;
    grid-template-columns: auto 160px auto auto auto 1fr 1fr 1fr 1fr auto auto auto;
