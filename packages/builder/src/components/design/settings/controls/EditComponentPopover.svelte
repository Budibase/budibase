<script>
  ...
  import ComponentSettingsSection from "@/pages/builder/app/[application]/design/app_[appId]/[screenId]/[componentId]/_components/Component/ComponentSettingsSection.svelte"
