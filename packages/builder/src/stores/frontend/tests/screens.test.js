...
import { componentStore, appStore } from "stores/frontend"
import { INITIAL_SCREENS_STATE, ScreenStore } from "stores/frontend/screens"
import {
  getScreenFixture,
  getComponentFixture,
...
vi.mock("stores/frontend/components/utils", () => {
  return {
