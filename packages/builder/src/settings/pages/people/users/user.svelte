<script lang="ts">
  ...
  import AppNameTableRenderer from "./_components/WorkspaceNameTableRenderer.svelte"
  import AppRoleTableRenderer from "./_components/WorkspaceRoleTableRenderer.svelte"
