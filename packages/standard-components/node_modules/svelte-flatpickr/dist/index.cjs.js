(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('svelte/internal'), require('svelte'), require('flatpickr')) :
	typeof define === 'function' && define.amd ? define(['svelte/internal', 'svelte', 'flatpickr'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.SvelteFlatpickr = factory(global.internal, global.svelte, global.flatpickr));
}(this, (function (internal, svelte, flatpickr) { 'use strict';
	...
	function fallback_block(ctx) {
		...
		return {
			...
			p(ctx, dirty) {
				internal.set_attributes(input_1, input_1_data = internal.get_spread_update(input_1_levels, [dirty & /*$$restProps*/ 2 && /*$$restProps*/ ctx[1]]));
			},
			d(detaching) {
			...
			p(ctx, [dirty]) {
				if (default_slot) {
					if (default_slot.p && (!current || dirty & /*$$scope*/ 512)) {
						internal.update_slot(default_slot, default_slot_template, ctx, /*$$scope*/ ctx[9], dirty, null, null);
					}
				} else {
	...
	function instance($$self, $$props, $$invalidate) {
		...
		svelte.onMount(() => {
			...
			$$invalidate(3, fp = flatpickr__default['default'](elem, Object.assign(opts, element ? { wrap: true } : {})));
		...
		$$self.$$set = $$new_props => {
			...
			$$invalidate(1, $$restProps = internal.compute_rest_props($$props, omit_props_names));
	...
	class Flatpickr extends internal.SvelteComponent {
		constructor(options) {
			super();
