...
var app = (function() {
  ...
  function create_if_block(ctx) {
    ...
    dispatch_dev("SvelteRegisterBlock", {
      ...
      type: "if",
      source: "(76:4) {#if !_children || _children.length === 0}",
      ctx,
    })
    return block
  }
  ...
  function create_fragment(ctx) {
    ...
    var if_block =
      (!ctx._children || ctx._children.length === 0) && create_if_block(ctx)
    ...
    const block = {
      ...
      l: function claim(nodes) {
        button = claim_element(
          nodes,
          "BUTTON",
          { class: true, disabled: true, style: true },
          false
        )
      ...
      h: function hydrate() {
        attr_dev(
          ...
          "class",
          (button_class_value =
            "" + ctx.className + " " + ctx.customClasses + " svelte-1smqkrd")
        )
      ...
      p: function update(changed, ctx) {
        ...
        if (
          (changed.className || changed.customClasses) &&
          button_class_value !==
            (button_class_value =
              "" + ctx.className + " " + ctx.customClasses + " svelte-1smqkrd")
        ) {
        ...
        if (
          changed.disabled &&
          button_disabled_value !==
            (button_disabled_value = ctx.disabled || false)
        ) {
        ...
        if (
          typeof cssVars_action.update === "function" &&
          changed.cssVariables
        ) {
  ...
  function instance($$self, $$props, $$invalidate) {
    ...
    $$self.$set = $$props => {
      ...
      if ("hoverBorder" in $$props)
        $$invalidate("hoverBorder", (hoverBorder = $$props.hoverBorder))
      if ("_children" in $$props)
        $$invalidate("_children", (_children = $$props._children))
    ...
    $$self.$capture_state = () => {
      return {
        ...
        cssVariables,
        buttonStyles,
        customHoverColorClass,
        customHoverBorderClass,
        customHoverBackClass,
        customClasses,
      }
    }
    ...
    $$self.$inject_state = $$props => {
      ...
      if ("_children" in $$props)
        $$invalidate("_children", (_children = $$props._children))
      if ("_bb" in $$props) $$invalidate("_bb", (_bb = $$props._bb))
      if ("theButton" in $$props)
        $$invalidate("theButton", (theButton = $$props.theButton))
      if ("cssVariables" in $$props)
        $$invalidate("cssVariables", (cssVariables = $$props.cssVariables))
      if ("buttonStyles" in $$props)
        $$invalidate("buttonStyles", (buttonStyles = $$props.buttonStyles))
      if ("customHoverColorClass" in $$props)
        customHoverColorClass = $$props.customHoverColorClass
      if ("customHoverBorderClass" in $$props)
        customHoverBorderClass = $$props.customHoverBorderClass
      if ("customHoverBackClass" in $$props)
        customHoverBackClass = $$props.customHoverBackClass
      if ("customClasses" in $$props)
        $$invalidate("customClasses", (customClasses = $$props.customClasses))
    }
  ...
  class Button extends SvelteComponentDev {
    constructor(options) {
      ...
      if (ctx.hoverBackground === undefined && !("hoverBackground" in props)) {
        console.warn(
          "<Button> was created without expected prop 'hoverBackground'"
        )
      }
  ...
  function create_each_block_1(ctx) {
    ...
    const block = {
      ...
      p: function update(changed, new_ctx) {
        ...
        if (
          changed._children &&
          t0_value !== (t0_value = ctx.navItem.title + "")
        ) {
    ...
    dispatch_dev("SvelteRegisterBlock", {
      ...
      type: "each",
      source: "(68:8) {#each _children as navItem, index}",
      ctx,
    })
    return block
  }
  ...
  function create_each_block(ctx) {
    ...
    dispatch_dev("SvelteRegisterBlock", {
      ...
      type: "each",
      source: "(77:4) {#each _children as navItem, index}",
      ctx,
    })
    return block
  }
  ...
  function instance$5($$self, $$props, $$invalidate) {
    ...
    Object.keys($$props).forEach(key => {
      if (!writable_props.includes(key) && !key.startsWith("$$"))
        console.warn(`<H1> was created with unknown prop '${key}'`)
    })
  ...
  class H1 extends SvelteComponentDev {
    ...
    get text() {
      throw new Error(
        "<H1>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'"
      )
    }

    set text(value) {
      throw new Error(
        "<H1>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'"
      )
    }
  ...
  function instance$6($$self, $$props, $$invalidate) {
    ...
    Object.keys($$props).forEach(key => {
      if (!writable_props.includes(key) && !key.startsWith("$$"))
        console.warn(`<Div> was created with unknown prop '${key}'`)
    })
    ...
    $$self.$inject_state = $$props => {
      ...
      if ("_bb" in $$props) $$invalidate("_bb", (_bb = $$props._bb))
      if ("rootDiv" in $$props)
        $$invalidate("rootDiv", (rootDiv = $$props.rootDiv))
    }
  ...
  class Div extends SvelteComponentDev {
    ...
    get _children() {
      throw new Error(
        "<Div>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'"
      )
    }

    set _children(value) {
      throw new Error(
        "<Div>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'"
      )
    }
  ...
  const createApp = (componentLibraries, appDefinition, user) => {
    ...
    const bb = (context, props) => ({
      ...
      insertChildren: (props, htmlElement, anchor, context) =>
        _initialiseChildren(context, false)(
          props,
          htmlElement,
          context,
          anchor
