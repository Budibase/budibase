...
var app = (function () {
    ...
    const clickHandler = () => {
    	...
    	function button_binding($$value) {
    		binding_callbacks[$$value ? 'unshift' : 'push'](() => {
    			$$invalidate('theButton', theButton = $$value);
    		});
    	}
    	...
    	$$self.$set = $$props => {
    		...
    		if ('_children' in $$props) $$invalidate('_children', _children = $$props._children);
    		if ('_bb' in $$props) $$invalidate('_bb', _bb = $$props._bb);
    	};

    	$$self.$capture_state = () => {
    		return { className, disabled, contentText, onClick, background, color, border, padding, hoverColor, hoverBackground, hoverBorder, _children, _bb, theButton, cssVariables, buttonStyles, customHoverColorClass, customHoverBorderClass, customHoverBackClass, customClasses };
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('_children' in $$props) $$invalidate('_children', _children = $$props._children);
    		if ('_bb' in $$props) $$invalidate('_bb', _bb = $$props._bb);
    		if ('theButton' in $$props) $$invalidate('theButton', theButton = $$props.theButton);
    	...
    	$$self.$$.update = ($$dirty = { _bb: 1, theButton: 1, _children: 1, hoverColor: 1, hoverBorder: 1, hoverBackground: 1, background: 1, color: 1, border: 1, padding: 1 }) => {
    		if ($$dirty._bb || $$dirty.theButton || $$dirty._children) { {
    ...
    class Button extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, ["className", "disabled", "contentText", "onClick", "background", "color", "border", "padding", "hoverColor", "hoverBackground", "hoverBorder", "_children", "_bb"]);
    		...
    		if (ctx._children === undefined && !('_children' in props)) {
    			console.warn("<Button> was created without expected prop '_children'");
    		}
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(img, file$1, 56, 12, 1148);
    			attr_dev(div, "class", "logo-container svelte-crnq0a");
    			add_location(div, file$1, 55, 8, 1107);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_if_block_1.name, type: "if", source: "(55:8) {#if _logo}", ctx });
    	return block;
    }
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(div, file$1, 84, 8, 1960);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_if_block$1.name, type: "if", source: "(84:8) {#if incorrect}", ctx });
    	return block;
    }
    ...
    function create_fragment$1(ctx) {
    	...
    	var if_block0 = (ctx._logo) && create_if_block_1(ctx);

    	var if_block1 = (ctx.incorrect) && create_if_block$1(ctx);
    ...
    const login = () => {
    	...
    	const writable_props = ['usernameLabel', 'passwordLabel', 'loginButtonLabel', 'loginRedirect', 'logo', 'buttonClass', 'inputClass', '_bb'];
    	Object.keys($$props).forEach(key => {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('incorrect' in $$props) $$invalidate('incorrect', incorrect = $$props.incorrect);
    		if ('_logo' in $$props) $$invalidate('_logo', _logo = $$props._logo);
    		if ('_buttonClass' in $$props) $$invalidate('_buttonClass', _buttonClass = $$props._buttonClass);
    		if ('_inputClass' in $$props) $$invalidate('_inputClass', _inputClass = $$props._inputClass);
    	};
    ...
    class Login extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, ["usernameLabel", "passwordLabel", "loginButtonLabel", "loginRedirect", "logo", "buttonClass", "inputClass", "_bb"]);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			attr_dev(input, "class", ctx.className);
    			attr_dev(input, "type", ctx.type);
    			input.value = ctx.value;
    			add_location(input, file$2, 18, 0, 241);
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	let { value="", className = "", type = "text", _bb } = $$props;
    ...
    const onchange = (ev) => {
    	...
    	const writable_props = ['value', 'className', 'type', '_bb'];
    	Object.keys($$props).forEach(key => {
    	...
    	$$self.$capture_state = () => {
    		return { value, className, type, _bb, actualValue };
    	};
    	...
    	return { value, className, type, _bb, onchange };
    }

    class Input extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, ["value", "className", "type", "_bb"]);
    		dispatch_dev("SvelteRegisterComponent", { component: this, tagName: "Input", options, id: create_fragment$2.name });

    		const { ctx } = this.$$;
    		const props = options.props || {};
    		if (ctx._bb === undefined && !('_bb' in props)) {
    			console.warn("<Input> was created without expected prop '_bb'");
    		}
    	}
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(div, file$3, 26, 0, 418);
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	let { value="", containerClass="", font="", textAlign="", verticalAlign="", color="", _bb } = $$props;

    let style="";

    	const writable_props = ['value', 'containerClass', 'font', 'textAlign', 'verticalAlign', 'color', '_bb'];
    	Object.keys($$props).forEach(key => {
    	...
    	$$self.$capture_state = () => {
    		return { value, containerClass, font, textAlign, verticalAlign, color, _bb, style };
    	};
    ...
    class Text extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, ["value", "containerClass", "font", "textAlign", "verticalAlign", "color", "_bb"]);
    		dispatch_dev("SvelteRegisterComponent", { component: this, tagName: "Text", options, id: create_fragment$3.name });
    ...
    function create_if_block$2(ctx) {
    	...
    	let each_value_1 = ctx._children;
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(div, file$4, 66, 4, 1790);
    		},
    		...
    		p: function update(changed, ctx) {
    			if (changed.selectedIndex || changed._children) {
    				each_value_1 = ctx._children;
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_if_block$2.name, type: "if", source: "(66:4) {#if !hideNavBar}", ctx });
    	return block;
    }

    // (68:8) {#each _children as navItem, index}
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(div, file$4, 68, 8, 1865);
    		...
    		p: function update(changed, new_ctx) {
    			ctx = new_ctx;
    			if ((changed._children) && t0_value !== (t0_value = ctx.navItem.title + "")) {
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_each_block_1.name, type: "each", source: "(68:8) {#each _children as navItem, index}", ctx });
    	return block;
    }

    // (77:4) {#each _children as navItem, index}
    function create_each_block(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(div, file$4, 77, 4, 2118);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_each_block.name, type: "each", source: "(77:4) {#each _children as navItem, index}", ctx });
    	return block;
    }
    ...
    function create_fragment$4(ctx) {
    	...
    	var if_block = (!ctx.hideNavBar) && create_if_block$2(ctx);

    	let each_value = ctx._children;
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(div, file$4, 64, 0, 1719);
    		},
    		...
    		p: function update(changed, ctx) {
    			...
    			if (changed.componentElements || changed._children) {
    				each_value = ctx._children;
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	let { navBarBackground = "", navBarBorder="", navBarColor="", selectedItemBackground="", selectedItemColor="", selectedItemBorder="", itemHoverBackground="", itemHoverColor="", hideNavBar=false, selectedItem="", _children, _bb } = $$props;
    ...
    const onSelectItem = (index) => () => {
    	...
    	const writable_props = ['navBarBackground', 'navBarBorder', 'navBarColor', 'selectedItemBackground', 'selectedItemColor', 'selectedItemBorder', 'itemHoverBackground', 'itemHoverColor', 'hideNavBar', 'selectedItem', '_children', '_bb'];
    	...
    	$$self.$set = $$props => {
    		...
    		if ('hideNavBar' in $$props) $$invalidate('hideNavBar', hideNavBar = $$props.hideNavBar);
    	...
    	$$self.$capture_state = () => {
    		return { navBarBackground, navBarBorder, navBarColor, selectedItemBackground, selectedItemColor, selectedItemBorder, itemHoverBackground, itemHoverColor, hideNavBar, selectedItem, _children, _bb, selectedIndex, styleVars, components, componentElements };
    	};
    ...
    class Nav extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, ["navBarBackground", "navBarBorder", "navBarColor", "selectedItemBackground", "selectedItemColor", "selectedItemBorder", "itemHoverBackground", "itemHoverColor", "hideNavBar", "selectedItem", "_children", "_bb"]);
    		dispatch_dev("SvelteRegisterComponent", { component: this, tagName: "Nav", options, id: create_fragment$4.name });

    		const { ctx } = this.$$;
    		const props = options.props || {};
    		if (ctx._children === undefined && !('_children' in props)) {
    			console.warn("<Nav> was created without expected prop '_children'");
    		}
    		if (ctx._bb === undefined && !('_bb' in props)) {
    ...
    /* src\H1.svelte generated by Svelte v3.12.1 */

    const file$5 = "src\\H1.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		...
    		l: function claim(nodes) {
    			...
    			t = claim_text(h1_nodes, ctx.text);
    			h1_nodes.forEach(detach_dev);
    			this.h();
    		},

    		h: function hydrate() {
    			attr_dev(h1, "class", ctx.className);
    			add_location(h1, file$5, 9, 0, 92);
    		},
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	let { text="", className="", _bb } = $$props;

    	const writable_props = ['text', 'className', '_bb'];
    	Object.keys($$props).forEach(key => {
    		if (!writable_props.includes(key) && !key.startsWith('$$')) console.warn(`<H1> was created with unknown prop '${key}'`);
    	});
    ...
    class H1 extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, ["text", "className", "_bb"]);
    		dispatch_dev("SvelteRegisterComponent", { component: this, tagName: "H1", options, id: create_fragment$5.name });

    		const { ctx } = this.$$;
    		const props = options.props || {};
    		if (ctx._bb === undefined && !('_bb' in props)) {
    			console.warn("<H1> was created without expected prop '_bb'");
    		}
    	}
    ...
    /* src\Div.svelte generated by Svelte v3.12.1 */

    const file$6 = "src\\Div.svelte";
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(div, file$6, 16, 0, 244);
    		},
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	let { _children = [], className="", onLoad, _bb } = $$props;

    let rootDiv;

    	const writable_props = ['_children', 'className', 'onLoad', '_bb'];
    	Object.keys($$props).forEach(key => {
    		if (!writable_props.includes(key) && !key.startsWith('$$')) console.warn(`<Div> was created with unknown prop '${key}'`);
    	});

    	function div_binding($$value) {
    		binding_callbacks[$$value ? 'unshift' : 'push'](() => {
    			$$invalidate('rootDiv', rootDiv = $$value);
    		});
    	}
    	...
    	$$self.$capture_state = () => {
    		return { _children, className, onLoad, _bb, rootDiv };
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('onLoad' in $$props) $$invalidate('onLoad', onLoad = $$props.onLoad);
    		if ('_bb' in $$props) $$invalidate('_bb', _bb = $$props._bb);
    		if ('rootDiv' in $$props) $$invalidate('rootDiv', rootDiv = $$props.rootDiv);
    	};

    	$$self.$$.update = ($$dirty = { _bb: 1, rootDiv: 1, _children: 1 }) => {
    		if ($$dirty._bb || $$dirty.rootDiv || $$dirty._children) { {
    ...
    class Div extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$6, create_fragment$6, safe_not_equal, ["_children", "className", "onLoad", "_bb"]);
    		dispatch_dev("SvelteRegisterComponent", { component: this, tagName: "Div", options, id: create_fragment$6.name });

    		const { ctx } = this.$$;
    		const props = options.props || {};
    		if (ctx.onLoad === undefined && !('onLoad' in props)) {
    			console.warn("<Div> was created without expected prop 'onLoad'");
    		}
    		if (ctx._bb === undefined && !('_bb' in props)) {
    			console.warn("<Div> was created without expected prop '_bb'");
    		}
    	}
    ...
    function create_each_block_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_each_block_2.name, type: "each", source: "(31:12) {#each columns as col}", ctx });
    	return block;
    }
    ...
    function create_if_block$3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_if_block$3.name, type: "if", source: "(37:8) {#if data}", ctx });
    	return block;
    }
    ...
    function create_each_block_1$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_each_block_1$1.name, type: "each", source: "(41:12) {#each columns as col, index}", ctx });
    	return block;
    }
    ...
    function create_each_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_each_block$1.name, type: "each", source: "(38:8) {#each data as row}", ctx });
    	return block;
    }
    ...
    class Table extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$7, create_fragment$7, safe_not_equal, ["columns", "data", "tableClass", "theadClass", "tbodyClass", "trClass", "thClass", "onRowClick", "_bb"]);
    		dispatch_dev("SvelteRegisterComponent", { component: this, tagName: "Table", options, id: create_fragment$7.name });
    ...
    function create_catch_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_catch_block.name, type: "catch", source: "(1:0) <script>  import createApp from \"./createApp\";  import { props }", ctx });
    	return block;
    }
    ...
    function create_then_block(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			attr_dev(div, "class", "svelte-uuhis1");
    			add_location(div, file$9, 27, 0, 423);
    		},
