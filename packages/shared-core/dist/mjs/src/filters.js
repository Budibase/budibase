import { SortType } from "@budibase/types";
 ...
 */
export const getValidOperatorsForType = (type, field, datasource // TODO: is this table id ever populated?
) => {
 ...
 */
export const luceneSort = (docs, sort, sortOrder, sortType = SortType.STRING) => {
