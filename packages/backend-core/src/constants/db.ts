...
export enum ViewName {
  ...
  FUNCTION_RUNS_BY_FUNCTION = "function_runs_by_function",
  COMPLETED_FUNCTION_RUNS_BY_STARTED_AT = "completed_function_runs_by_started_at",
  RUNNING_FUNCTION_RUNS_BY_STARTED_AT = "running_function_runs_by_started_at",
