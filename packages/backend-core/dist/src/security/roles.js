...
const BUILTIN_ROLES = {
    ...
    PUBLIC: new Role(BUILTIN_IDS.PUBLIC, "Public").addPermission(BUILTIN_PERMISSION_IDS.PUBLIC),
    BUILDER: new Role(BUILTIN_IDS.BUILDER, "Builder").addPermission(BUILTIN_PERMISSION_IDS.ADMIN),
};
 ...
 */
exports.getRole = (roleId) => __awaiter(void 0, void 0, void 0, function* () {
    if (!roleId) {
        return null;
    }
    let role = {};
    ...
    try {
        const db = getAppDB();
        const dbRole = yield db.get(exports.getDBRoleID(roleId));
...
function getAllUserRoles(userRoleId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let currentRole = yield exports.getRole(userRoleId);
        ...
        while (currentRole &&
            ...
            currentRole = yield exports.getRole(currentRole.inherits);
 ...
 */
exports.getUserRoleHierarchy = (userRoleId, opts = { idOnly: true }) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
exports.getAllRoles = (appId) => __awaiter(void 0, void 0, void 0, function* () {
    if (appId) {
    ...
    function internal(db) {
        return __awaiter(this, void 0, void 0, function* () {
            let roles = [];
            if (db) {
                const body = yield db.allDocs(getRoleParams(null, {
                    include_docs: true,
                }));
            ...
            for (let builtinRoleId of EXTERNAL_BUILTIN_ROLE_IDS) {
                ...
                const dbBuiltin = roles.filter(dbRole => exports.getExternalRoleID(dbRole._id) === builtinRoleId)[0];
                if (dbBuiltin == null) {
            ...
            for (let role of roles) {
                ...
                for (let resourceId of Object.keys(role.permissions)) {
                    role.permissions = exports.checkForRoleResourceArray(role.permissions, resourceId);
                }
            }
            return roles;
        });
 ...
 */
exports.getRequiredResourceRole = (permLevel, { resourceId, subResourceId }) => __awaiter(void 0, void 0, void 0, function* () {
    const roles = yield exports.getAllRoles();
    let main = [], sub = [];
    for (let role of roles) {
...
class AccessController {
    ...
    hasAccess(tryingRoleId, userRoleId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!roleIds) {
                roleIds = yield exports.getUserRoleHierarchy(userRoleId);
