...
const { DocumentTypes, SEPARATOR, ViewNames, getAllApps, } = require("./db/utils");
...
const { getSessionsForUser, invalidateSessions, } = require("./security/sessions");
...
function resolveAppUrl(ctx) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const apps = yield tenancy.doInTenant(tenantId, () => getAllApps({ dev: false }));
 ...
 */
exports.getAppIdFromCtx = (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    // look in headers
...
const getBuilders = () => __awaiter(void 0, void 0, void 0, function* () {
    const builders = yield queryGlobalView(ViewNames.USER_BY_BUILDERS, {
        include_docs: false,
    });
    if (!builders) {
        return [];
...
exports.getBuildersCount = () => __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
exports.platformLogout = ({ ctx, userId, keepActiveSession }) => __awaiter(void 0, void 0, void 0, function* () {
    if (!ctx)
        throw new Error("Koa context must be supplied to logout.");
    const currentSession = exports.getCookie(ctx, Cookies.Auth);
    let sessions = yield getSessionsForUser(userId);
    ...
    yield invalidateSessions(userId, { sessionIds, reason: "logout" });
