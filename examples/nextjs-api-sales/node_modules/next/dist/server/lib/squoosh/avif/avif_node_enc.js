...
/* eslint-disable */ var Module = function() {
    return function(Module) {
        ...
        var dynCall_jiiiiiiiii = Module['dynCall_jiiiiiiiii'] = function() {
            return (dynCall_jiiiiiiiii = Module['dynCall_jiiiiiiiii'] = Module['asm']['Z']).apply(null, arguments);
        };
        var dynCall_ijiii = Module['dynCall_ijiii'] = function() {
            return (dynCall_ijiii = Module['dynCall_ijiii'] = Module['asm']['_']).apply(null, arguments);
        };
        ...
        var dynCall_jiiiiiiii = Module['dynCall_jiiiiiiii'] = function() {
            return (dynCall_jiiiiiiii = Module['dynCall_jiiiiiiii'] = Module['asm']['aa']).apply(null, arguments);
        };
        var dynCall_jiiiiii = Module['dynCall_jiiiiii'] = function() {
            return (dynCall_jiiiiii = Module['dynCall_jiiiiii'] = Module['asm']['ba']).apply(null, arguments);
        };
        var dynCall_jiiiii = Module['dynCall_jiiiii'] = function() {
            return (dynCall_jiiiii = Module['dynCall_jiiiii'] = Module['asm']['ca']).apply(null, arguments);
        };
        var dynCall_iiijii = Module['dynCall_iiijii'] = function() {
            return (dynCall_iiijii = Module['dynCall_iiijii'] = Module['asm']['da']).apply(null, arguments);
        };
